...
A combined PDF with all the notes is available [here](/assets/dm_notes/combined_data_notes.pdf). Specific chapters are listed below, but please be aware that links in the chapter-specific PDFs are not currently functional.
...
<div style="clear: both;">
{{< readfile "assets/dm_notes/data_management_table.html" >}}
</div>
