...
My name is Nick Ross and I'm currently a professor at the University of Chicago's [Data Science Institute](https://datascience.uchicago.edu/) where I serve two roles: Director of the [Data Science Core facility](https://core.datascience.uchicago.edu/) and Director of the [Data Science Clinic](https://datascience.uchicago.edu/education/data-science-clinic/). I was formerly the CTO of [Classify](https://tryclassify.com/), an AI contextual platform. Beyond these roles, I advise and invest in startups, personally as well as through the [Polsky Center's Transform Data Science and AI Accelerator](https://polsky.uchicago.edu/programs-events/transform/). Finally, I sit on the advisory board of [Michigan State University's Analytics Program](https://broad.msu.edu/masters/business-data-science-analytics/board/).

I'm deeply interested in how AI is reshaping work, institutions, and everyday life. My current focus is on ensuring that AI systems are developed and deployed in ways that expand opportunity — particularly for communities and organizations that haven't traditionally had a seat at the table. This means working on practical AI governance, building workforce capacity, and helping nonprofits and public-sector partners use these tools effectively.

Before the University of Chicago, I was Director of Backend Engineering and Data Science at [Kovaak's Aim Trainer](https://kovaaks.com/kovaaks/main). I spend most of my time working with [boring technologies](http://boringtechnology.club/) (Node, Python, K8s, Docker, PostgreSQL and Redis for example). I design cost-effective, scalable, cloud-based backend and data systems (ML/AI) as well as assemble the teams that build them. This includes all the fun stuff keeping the systems up at night.
...
On the [research]({% link research.md %}) side I study how companies leverage data to make decisions. Currently I'm working on a book on [Data Management]({% link datamanagement.md %}) using Pandas and SQL.
